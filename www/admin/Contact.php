...
if(isset($_POST['keydel']) && $_POST['keydel']=='delete')
{
	...
	//print_r($ids);
	//exit();
	$sql = "DELETE FROM complain WHERE ID IN (".$ids.")";
	mysql_query($sql) or die(mysql_error());

	$msg = '<div class="callout callout-success">
			<h4>Complain has been deleted</h4>
		  </div>';
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"> Contact/Enquiry</li>
      </ol>
    </section> 
   <!--  <button style="float:right" id="btndel" type="button" class="btn btn-danger btn-sm">Delete</button>
   <button type="button" style="float:right; margin-right:20px;" onClick="location.href='AddNewRole.php'" class="btn-info btn btn-sm">Add</button>
    --><!-- Main content -->
    <?php
	...
	?>
       ...
       <!--           <th></th>-->
               ...
               <!--   <td><button onclick="location.href='EditRole.php?RoleID=<?php echo $row['ID'];?>'" type="button" class="btn btn-info btn-sm">Edit</button></td>-->
                </tr>
                 <?php
				}
				?>
