...
if(isset($_REQUEST["UserID"]) && ctype_digit($_REQUEST["UserID"]))
...
{
	$sql = "SELECT ID,Username,RoleID,Password,EmailAddress,Status FROM user WHERE ID ='".$UserID."'";
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              ...
              <button type="submit" onClick="location.href='User.php'" class="btn btn-default pull-right">Back</button>
            </div>
			<?php
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo $self;?>?UserID=<?php echo $UserID; ?>" method="post">
              <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputEmail3" name="Username" value="<?php echo $Username; ?>" placeholder="Enter User Name">
                  </div>
                </div>
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="password" class="form-control" id="inputPassword3" name="Password" value="<?php echo $Password; ?>" placeholder="Password">
                  </div>
                </div>
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputEmail3" name="EmailAddress" value="<?php echo $EmailAddress; ?>" placeholder="Email">
                  </div>
                </div>
