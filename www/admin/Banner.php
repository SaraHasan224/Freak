            ...
            <form action="<?php echo $self; ?>" id="formdel" method="post">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th><img style="width:60px;" src="<?php echo DIR_UPLOADING_BANNER.$row['Image'];?>"/></th>
                  ...
                  <td><button onclick="location.href='EditBanner.php?BlogID=<?php echo $row['ID'];?>'" type="button" class="btn btn-info btn-sm">Edit</button></td>
                </tr>
                 <?php
				}
				?>
