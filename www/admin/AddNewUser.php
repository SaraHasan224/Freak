            ...
            <form class="form-horizontal" action="<?php echo $self; ?>" method="post">
              <div class="box-body">
			    ...
			    <select class="form-control" name="RoleID">
					...
					{
					?>
                    <option <?php echo($RoleID==$row['ID'] ? 'selected' : '' ); ?> value="<?php echo $row['ID']; ?> ><?php echo $row['RoleName']; ?></option>
					<?php
					}
					?>
                </select>
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="email" class="form-control" id="inputEmail3" name="EmailAddress" value="<?php $EmailAddress; ?>" placeholder="Enter Email-Address">
                  </div>
                </div>
