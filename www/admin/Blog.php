...
if(isset($_POST['keydel']) && $_POST['keydel']=='delete')
{
	...
	$sql = "DELETE FROM blogs WHERE ID IN (".$ids.")";
	mysql_query($sql) or die(mysql_error());
	
	$msg = '<div class="callout callout-success">
                <h4>Brand has been deleted</h4>
            </div>';
	
}
$sql = "SELECT ID,Status,Image,Description,Title,DATE_FORMAT(DateAdded,'%b %d %Y %h:%i %p') as Added ,DATE_FORMAT(DateModified,'%b %d %Y %h:%i %p') as Updated FROM blogs where ID<>0";
		  ...
		  if($(".chkIds").is(":checked"))
			{
				...
				alert("Please select Blog to delete");
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <button type="button" style="float:right; margin-right:20px;" onClick="location.href='AddNewBlog.php'" class="btn-info btn btn-sm">Add</button>
    <!-- Main content -->
    <?php
            ...
            <form action="<?php echo $self; ?>" id="formdel" method="post">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th><img style="width:60px;" src="<?php echo DIR_UPLOADING_BLOGS.$row['Image'];?>"/></th>
                  ...
                  <td><button onclick="location.href='EditBlogs.php?BlogID=<?php echo $row['ID'];?>'" type="button" class="btn btn-info btn-sm">Edit</button></td>
                </tr>
                 <?php
				}
				?>
