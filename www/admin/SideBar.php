    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="header">MAIN NAVIGATION</li>
		        <li><a href="Dashboard.php"><i class="fa fa-circle-o text-red"></i> <span>Dashboard</span></a></li>
         <?php
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="User.php"><i class="fa fa-circle-o"></i>Users</a></li>
		...
		<li class="treeview">
          <a href="#">
            <i class="fa fa-dashboard"></i> <span>Website Management</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            ...
            <li><a href="Brand.php"><i class="fa fa-circle-o"></i>Brands</a></li>
            <li><a href="Blog.php"><i class="fa fa-circle-o"></i>Blog</a></li>
          </ul>
        </li>
		<?php
		}
		if((isset($_SESSION['Inventory'])) || (isset($_SESSION['Admin'])))
		{
		?>
		<li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="Catagories.php"><i class="fa fa-circle-o"></i>Categories</a></li>
            <li><a href="Products.php"><i class="fa fa-circle-o"></i>Products</a></li>
            <li><a href="CustomField.php"><i class="fa fa-circle-o"></i>Custom Field</a></li>
          </ul>
        </li>
		<?php
		}
		if((isset($_SESSION['Finance'])) || (isset($_SESSION['Admin'])))
		{
		?>
		<li class="treeview">
          <a href="#">
		...
		if((isset($_SESSION['Support'])) || (isset($_SESSION['Admin'])))
		{
		?>
		<li class="treeview">
          <a href="#">
            <i class="fa fa-dashboard"></i> <span>Customer Support</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="Contact.php"><i class="fa fa-circle-o"></i>Enquiry</a></li>
