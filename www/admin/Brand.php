...
$sql = "SELECT ID,Status,BrandName,Description,Image,DATE_FORMAT(DateAdded,'%b %d %Y %h:%i %p') as Added ,DATE_FORMAT(DateModified,'%b %d %Y %h:%i %p') as Updated FROM brands where ID<>0";
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <button type="button" style="float:right; margin-right:20px;" onClick="location.href='AddNewBrand.php'" class="btn-info btn btn-sm">Add</button>
    <!-- Main content -->
    <?php
            ...
            <form action="<?php echo $self; ?>" id="formdel" method="post">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th><img style="width:60px;" src="<?php echo DIR_UPLOADING_BRAND.$row['Image'];?>"/></th>
                  <th><?php echo $row['Added']; ?></th>
                  <th><?php echo $row['Updated']; ?></th>
                  <td><button onclick="location.href='EditBrands.php?ProductID=<?php echo $row['ID'];?>'" type="button" class="btn btn-info btn-sm">Edit</button></td>
                </tr>
                 <?php
				}
				?>
