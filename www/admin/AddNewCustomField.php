...
if(isset($_POST["submit_key"])&& $_POST['submit_key'] == 'submit_value')
{
	...
	else if(count($Options)==1 && $Options[0]=="")
	{
		$msg ='<div class="callout callout-danger">

                <p>Please Enter atleast one Option</p>
              </div>';
	}
	...
	if($msg == "")
	{
		...
		$sql = "INSERT INTO customfield SET
                Status = '".(int)$Status."',
                FieldName = '".$FieldName."',
                Type = '".(int)$TypeID."',
                Options = '".$Options."',
		...
		$_SESSION['msg'] ='<div class="callout callout-success">
                ...
                <p>Custom Field has been added.</p>
              </div>';	
		redirect($self);
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Add New Custom Field</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Add New Custom Field</h3>
