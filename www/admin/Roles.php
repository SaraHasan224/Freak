...
if(isset($_POST['keydel']) && $_POST['keydel']=='delete')
{
	...
	//print_r($ids);
	//exit();
	$sql = "DELETE FROM roles WHERE ID IN (".$ids.")";
...
$sql = "SELECT ID,RoleName,Status,DATE_FORMAT(DateAdded,'%b %d %Y %h:%i %p') as Added,DATE_FORMAT(DateModified,'%b %d %Y %h:%i %p') as Updated FROM roles";
