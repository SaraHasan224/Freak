...
if(isset($_POST['keydel']) && $_POST['keydel']=='delete')
{
	...
	$ids = implode(",",$ids);
	$sql = "DELETE FROM slider_main WHERE ID IN (".$ids.")";
	mysql_query($sql) or die(mysql_error());
	
	$msg = '<div class="callout callout-success">
                <h4>Image has been deleted</h4>
              </div>';
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Slider_main</h3>
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><img style="width:60px;" src="<?php echo DIR_UPLOADING_SLIDER.$row['Image'];?>"/></td>
