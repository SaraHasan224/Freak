...
if(isset($_REQUEST["RoleID"]) && ctype_digit($_REQUEST["RoleID"]))
...
{
	$sql ="SELECT ID,RoleName,Status FROM roles WHERE ID='".$RoleID."'";
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
			  ...
			  <button type="submit" class="btn btn-default pull-right" onClick="location.href='Roles.php'">Back</button>
			</div>
            <?php
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo $self;?>?RoleID=<?php echo $RoleID;?>" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputEmail3" name="RoleName" value="<?php echo $RoleName; ?>" placeholder="Enter Role Name">
                  </div>
                </div>
