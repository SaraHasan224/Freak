        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
			  ...
			  <button type="submit" onClick="location.href='Products.php'" class="btn btn-default pull-right">Back</button>
            </div>
			<?php
              ...
              <div class="box-body">
			   ...
			   <div class="form-group">
				...
				<?php
					...
					{
				?>
					<input type="checkbox" class="chkIds" name="CatIDs[]" value="<?php echo $row['ID']; ?>" <?php echo(in_array($row['ID'],$CatIDs) ? 'checked' : '' ); ?> />&nbsp;&nbsp;<?php echo $row['CatagoryName'];?>
					<br>
					<?php
					}
					?>
