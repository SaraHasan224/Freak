...
if(isset($_POST['keydel']) && $_POST['keydel']=='delete')
{
	...
	$msg = '<div class="callout callout-success">
                <h4>Employee has been deleted</h4>
            </div>';
	
}
$sql = "SELECT ID,Status,Name,Designation,Image,Experience,DATE_FORMAT(DateAdded,'%b %d %Y %h:%i %p') as Added ,DATE_FORMAT(DateModified,'%b %d %Y %h:%i %p') as Updated FROM about where ID<>0";
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <button type="button" style="float:right; margin-right:20px;" onClick="location.href='AddNewAboutUs.php'" class="btn-info btn btn-sm">Add</button>
    <!-- Main content -->
    <?php
            ...
            <form action="<?php echo $self; ?>" id="formdel" method="post">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th><img style="width:60px;" src="<?php echo DIR_UPLOADING_ABOUT.$row['Image'];?>"/></th>
